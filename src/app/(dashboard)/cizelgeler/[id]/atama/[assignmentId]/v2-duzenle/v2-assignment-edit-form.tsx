...
export function V2AssignmentEditForm({
  action,
  scheduleId,
  currentPharmacyId,
  candidatePharmacies,
    ...
    <form action={formAction} className="flex max-w-lg flex-col gap-4">
      <div className="flex flex-col gap-1.5">
        ...
        <p className="text-muted-foreground text-xs">
          Yalnızca bu atamanın ait olduğu rotasyon havuzunun üyesi olan eczaneler
          listelenir. Onaylı nöbet tutamama/acil mazeret talebi olan eczaneler bu
          tarih için seçilemez.
        </p>
      </div>
