...
export function HistoricalImportForm() {
  ...
  return (
    <form action={formAction} className="flex flex-col gap-4">
      ...
      {/* Onay adımı, önizlemede analiz edilen satırlar üzerinden çalışır;
          dosyanın yeniden seçilmesi gerekmez. */}
      {state.rawRowsJson && (
        <>
          <input type="hidden" name="rawRows" value={state.rawRowsJson} />
      ...
      <p className="text-muted-foreground text-xs">
        Not: İçe aktarım, son önizlemede görüntülenen veriler üzerinden yapılır ve
        sistem kaydetmeden önce tüm kontrolleri yeniden çalıştırır. Geçmiş kayıtlar
        hiçbir zaman yeni nöbet ataması oluşturmaz; yalnızca denge skorunu etkiler.
        Eşleşmeyen kayıtlar saklanır ancak denge skoruna katılmaz.
      </p>
    </form>
  );
}
